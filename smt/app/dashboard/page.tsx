                  ...
                  {["Locations", "Date", "Time"].map((field, idx) => (
                    <div key={idx} className="flex-1">
                      ...
                      <select className="w-full bg-white border rounded-md p-2 text-sm">
                        <option>{field === "Locations" ? "New York" : field === "Date" ? "June 09, 2024" : "6:00 AM"}</option>
                        <option>{field === "Locations" ? "Los Angeles" : field === "Date" ? "July 10, 2024" : "08:00 AM"}</option>
                        <option>{field === "Locations" ? "Miami" : field === "Date" ? "August 11, 2024" : "11:00 PM"}</option>
                        <option>{field === "Locations" ? "Chicago" : field === "Date" ? "September 12, 2024" : "01:00 AM"}</option>
                        <option>{field === "Locations" ? "Paris" : field === "Date" ? "October 13, 2024" : "04:00 AM"}</option>
                      </select>
                    </div>
                  ))}
                </div>
